...
export default function SignIn(){
    ...
    const [passwordCanBeFill, setPasswordCanBeFill]= useState(false);
        ...
        >
            <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
                ...
                <View style={{gap:16, width: "100%" , alignItems: 'center'}}>
                    ...
                    <ButtonUi onPress={handleSubmit} title= "Agree and continue" type={isFormValid ? 'primary' : 'disabled'}/>
                    <ButtonUi href={"./SignIn"} title="J'ai déjà un compte" type="secondary" />
                </View>
            </ScrollView>
        </KeyboardAvoidingView>
    );
